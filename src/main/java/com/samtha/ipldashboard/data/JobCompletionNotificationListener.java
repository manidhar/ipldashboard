...
public class JobCompletionNotificationListener extends JobExecutionListenerSupport {
  ...
  public void afterJob(JobExecution jobExecution) {
    if(jobExecution.getStatus() == BatchStatus.COMPLETED) {
      ...
      // As same team name can exist in team 1 and team 2 will be combining both team 1 and team 2 counts to get total match played by each team
      ...
      // updating the matches won by team
      ...
      // TODO : Need to build the logic for total ties.
